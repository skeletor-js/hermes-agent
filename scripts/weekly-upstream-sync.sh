...
echo "  3. uv pip install -e '.[messaging,cron]'"
echo "  4. python3 -c 'import discord; print(\"discord.py:\", discord.__version__)'"
echo "  5. python3 -c 'import telegram; print(\"python-telegram-bot:\", telegram.__version__)'"
echo "  6. bash scripts/install-superbud-hook.sh --check"
echo "  7. hermes webapi --port 8652"
echo "  8. In another shell: HERMES_API_URL=http://127.0.0.1:8652 bash scripts/smoke-test-webapi.sh"
echo "  9. Manually verify Hermes Workspace loads and chat/sessions/memory/skills work"
echo ""
echo "WARNING: Do NOT use 'uv pip install -e .' alone -- it drops telegram/discord deps."
echo
